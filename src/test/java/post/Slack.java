...
public class Slack {
    ...
    public void sendMessageTest() throws URISyntaxException, IOException {
        ...
        post.setHeader("Authorization", "Bearer xoxb-1717144054548-2225306696261-wDWBqOUIhTzF4rAanFvdThNH");

        HttpEntity entity = new StringEntity(PatPayLoadUtils.getSlackMessagePayLoad("C026Q9VVD42",
                "Hello Techtorial"));
